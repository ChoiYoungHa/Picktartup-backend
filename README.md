...
📌 **관련 기사**  
[“벤처‧스타트업 숙원 BDC(개인투자자 자금기반 스타트업, 벤처 공모펀드)‘차일피일’ 도입 미뤄져”](hhttps://www.m-i.kr/news/articleView.html?idxno=1052539)  
...
### ✨ 개발 필요성
이러한 문제를 해결하기 위해 **Picktartup**은 **블록체인 기반 스타트업 조각 투자 플랫폼**을 개발하여 **소액 투자 가능**, **투명한 거래 내역 공개**, **자동화된 투자 시스템**을 제공함으로써 더 많은 사람들이 스타트업 투자에 쉽게 접근하고 신뢰할 수 있도록 합니다.
